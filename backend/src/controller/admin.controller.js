...
const uploadToCloudinary = async(file)=>{
    try {
        ...
        console.log("Cloudinary keys:", process.env.CLOUD_NAME, process.env.API_KEY);


        console.log("error in the uploadCloudinary",error)
        throw new Error("error uploading in cloudinary",error)
